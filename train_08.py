...
from srgan_torch import SRGAN_g, SRGAN_d, SRGAN_g_lr, SRGAN_d_lr, SRGAN_g_lr_upsample, SRGAN_g_lr_smallFeature
...
version = 'v0.82' # check the version.txt file for historical versions under output directory
save_dir = "samples"
elevation = False
elevation_hr = False
...
def train():
    ...
    # Define optimizers
    g_optimizer_init = optim.Adam(G.parameters(), lr=3e-4)
