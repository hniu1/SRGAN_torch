"""Variable-aware SwinV2 super-resolution model for multivariable downscaling."""
...
class REFINEConfig:
    ...
    @classmethod
    def from_dict(cls, raw: dict) -> "REFINEConfig":
        values = dict(raw)
...
class ResidualSwinGroup(nn.Module):
    def __init__(self, config: REFINEConfig, drop_paths: Sequence[float]) -> None:
        super().__init__()
