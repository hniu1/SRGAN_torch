...
```bash
/lustre/orion/proj-shared/cli138/7hn/envs/torch_rocm/bin/python pipeline_04_downscale_stage1.py --help
```

## Stage 1: 1 degree to 0.25 degree

```bash
/lustre/orion/proj-shared/cli138/7hn/envs/torch_rocm/bin/python pipeline_04_downscale_stage1.py \
