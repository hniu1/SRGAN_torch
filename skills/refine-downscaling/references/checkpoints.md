...
|---|---|---|---|
| Stage 1 | `artifacts/data/daymet_mv_1980_1990/manifest.json` | `artifacts/runs/refine_stage1_v1/best.pt` | 4x |
| Stage 2 | `artifacts/data/daymet_mv_stage2_1980_1990/manifest.json` | `artifacts/runs/refine_stage2_v1/best.pt` | 6x |
