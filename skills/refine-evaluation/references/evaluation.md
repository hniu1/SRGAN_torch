...
```bash
python pipeline_03_evaluate_stage1.py \
  --data-dir artifacts/data/daymet_mv_1980_1990 \
  --checkpoint artifacts/runs/refine_stage1_v1/best.pt \
  --output-dir artifacts/runs/refine_stage1_v1/test_1990 \
  --split test \
  --batch-size 1 \
  --amp \
  --no-save-predictions \
...
python pipeline_07_evaluate_stage2.py \
  ...
  --output-dir artifacts/runs/refine_stage2_v1/test_1990 \
  --split test \
  --batch-size 1 \
  --amp \
  --no-save-predictions \
...
python utility_plot_spatial_statistics.py \
  --data-dir artifacts/data/daymet_mv_stage2_1980_1990 \
  --evaluation-dir artifacts/runs/refine_stage2_v1/test_1990 \
  --split test \
  --tile-rows 21
```
