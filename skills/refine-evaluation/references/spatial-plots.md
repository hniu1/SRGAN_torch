...
When `spatial_statistics_1990.npz` already exists, use
`utility_plot_spatial_statistics.py --reuse-statistics` to refresh labels or
styling without rereading the full prediction and truth time series.
