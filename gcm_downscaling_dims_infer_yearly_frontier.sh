#!/bin/bash
#SBATCH -A cli138
#SBATCH -J srgan-yearly
#SBATCH -o ./logs/srgan-yearly-%j.out
#SBATCH -e ./logs/srgan-yearly-%j.err
#SBATCH -p extended
#SBATCH -q extended
#SBATCH -N 1
...
## ACCESS-CM2 pr, 2020-2059 input span (YEAR_END is exclusive, so 2060 means through 2059-12)
# MODE=downscale MODEL=ACCESS-CM2 VAR=pr YEAR_START=2020 YEAR_END=2060 sbatch gcm_downscaling_dims_infer_yearly.sh
# MODE=save-nc  MODEL=ACCESS-CM2 VAR=pr YEAR_START=2020 YEAR_END=2060 sbatch gcm_downscaling_dims_infer_yearly_frontier.sh
# MODEL=ACCESS-CM2 VAR=pr YEAR_START=2020 YEAR_END=2060 sbatch gcm_downscaling_dims_infer_yearly.sh