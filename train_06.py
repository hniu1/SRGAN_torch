...
version = 'v0.63' # check the version.txt file for historical versions under output directory
save_dir = "samples"
elevation = False
elevation_hr = False
...
if args.mode == 'train' and readrawdata:
    train_lr, test_lr, train_hr, test_hr = daymetread(path_output, checkpoint_dir, elevation, elevation_hr, high_deg=False, scaler = 'log')
    # Load the scaler
