...
if __name__ == '__main__':
    ...
    # var='tmin'
    version = '0.5'
    path_gcm = f'/mnt/data/ClimateSR/gcm/pr_day_MPI-ESM1-2-HR_ssp245_r1i1p1f1_gn_202001-205912_1deg_Daymet_ERA5_VICa_BC.nc'

    # #only run this line if the first time
    # DaymetData.DaymetCombine(var=var)

    GCM_downscaling = GCM_Downscaling(version_lr = '2.6',
                                      version_hr = '5.4',
