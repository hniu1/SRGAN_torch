#!/usr/bin/env python3
"""Train the patch-based multivariable REFINE downscaler."""
...
def load_training_layout(data_dir: Path):
    ...
    if layout == "netcdf_patch_index":
        from refine_downscaling.stage2_data import (
...
def main() -> None:
    ...
    try:
        ...
        model = REFINE(config).to(context.device)
