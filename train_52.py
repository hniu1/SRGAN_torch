...
from srgan_torch import SRGAN_g, SRGAN_d, SRGAN_g_lr, SRGAN_d_lr, SRGAN_g_hr_26, SRGAN_g_hr_26_64RB, SRGAN_d_hr, SRGAN_g_lr_smallFeature, SRGAN_d_lr_large, SRGAN_d_lr_odd, SRGAN_d_hr_odd
...
version = 'v5.2' # check the version.txt file for historical versions under output directory
save_dir = "samples"
elevation = True
elevation_hr = False
...
D = SRGAN_d_hr(hr_size=train_hr[0].shape[0]*train_hr[0].shape[1]).to(device)
